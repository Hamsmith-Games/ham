...
namespace ham{
	...
	namespace meta{
		...
		namespace detail{
			...
			struct index_seq_builder: index_seq_builder<N-1, N-1, Built...>{};
	...
	namespace meta{
		...
		struct type_list_contains<type_list<T, Us...>, T>{
			enum { value = true };
		};

		template<typename T, typename U, typename ... Us>
		struct type_list_contains<type_list<U, Us...>, T>{
			enum { value = type_list_contains<type_list<Us...>, T>::value };
		};
